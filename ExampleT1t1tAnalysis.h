//////////////////////////////////////////////////////////
// 
//  Analysis code for the T1t1t model
//  Author: Dominic Smith, University of Bristol/VUB
//  Date: June 2014
// 
//////////////////////////////////////////////////////////

#ifndef ExampleT1t1tAnalysis_h
#define ExampleT1t1tAnalysis_h
...
const Int_t kMaxParticle = 30;
const Int_t kMaxTrack = 4;
const Int_t kMaxTower = 14;
const Int_t kMaxEFlowTrack = 4;
const Int_t kMaxEFlowTower = 14;
...
public :
  ...
  Int_t           ScalarHT_size;
   ...
   ExampleT1t1tAnalysis(TTree *tree=0);
   virtual ~ExampleT1t1tAnalysis();
   virtual Int_t    Cut();
...
private:
   ...
   std::vector<Float_t> jetpts;            // Vector of jet PTs per event
   ...
   std::vector<Float_t> DeltaRs;

   TLorentzVector Top;                     // Assigning TLorentzVectors to our particles
   TLorentzVector Stop;
   TLorentzVector Bottom;
   TLorentzVector WBoson;
   TLorentzVector Lsp;
   TLorentzVector Gluino;
...
#ifdef ExampleT1t1tAnalysis_cxx
ExampleT1t1tAnalysis::ExampleT1t1tAnalysis(TTree *tree) : fChain(0)     // THIS IS MY CONSTRUCTOR
{
// if parameter tree is not specified (NEVER IS)(or zero), connect the file
// used to generate this class and read the Tree.
   ...
   Init(tree);      // Calls function Init
}

ExampleT1t1tAnalysis::~ExampleT1t1tAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ExampleT1t1tAnalysis::GetEntry(Long64_t entry)
{
...
Long64_t ExampleT1t1tAnalysis::LoadTree(Long64_t entry)
{
...
void ExampleT1t1tAnalysis::Init(TTree *tree)
{
...
Bool_t ExampleT1t1tAnalysis::Notify()
{
...
void ExampleT1t1tAnalysis::Show(Long64_t entry)
{
...
Int_t ExampleT1t1tAnalysis::Cut()
{
...
#endif // #ifdef ExampleT1t1tAnalysis_cxx
